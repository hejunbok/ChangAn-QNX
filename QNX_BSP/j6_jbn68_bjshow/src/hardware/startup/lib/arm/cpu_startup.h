...
/*
 * ------------------------------------------------------------------
 * HVC reboot callout support
 * ------------------------------------------------------------------
 */
extern struct callout_rtn	reboot_hvc;
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/startup/lib/arm/cpu_startup.h $ $Rev: 771583 $")
#endif
