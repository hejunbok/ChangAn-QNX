...
#define VARIANT_DUMMY

//#define MCLK                 11289600L
#define MCLK                    12288000L
...
/*
 * DUMMY's MCLK comes from the BCLK and it requires this to be no less than 2MHz
...
#define MCASP3_DMA_PLAY     58
#define MCASP3_DMA_CAP      59
...
#define MCASP3_TX_IRQ       (125 + 32)
#define MCASP3_RX_IRQ       (126 + 32)
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/deva/ctrl/mcasp/nto/arm/dll.le.j6_dummy.v7/variant.h $ $Rev: 740198 $")
#endif
