...
#define QSPI_CMD_3PP_032p					0x02	// page program with 3 bytes address
...
#define QSPI_CMD_BLK_ERASE_032p			0x60	// block erase
#define QSPI_CMD_3SE_032p					0xD8    // 64KB sector erase, 4B address
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/ipl/boards/dra74x/qspi.h $ $Rev: 772559 $")
#endif
