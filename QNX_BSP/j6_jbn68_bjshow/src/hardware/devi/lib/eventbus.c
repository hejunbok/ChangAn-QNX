...
bus_create (void)
{
	...
	memset (p, 0, sizeof (event_bus_line_t));
	...
	for (bp = Bus; bp; bp = bp->next) {
		...
		if (OptFlags & OPT_RESMGR) {
			...
			case DEVI_CLASS_REL:
				...
				memset (bp->u.mq, 0, (bp->elem_size * RESMGR_Q_SIZE));
				break;
			...
			case DEVI_CLASS_KBD:
				...
				memset (bp->u.kq, 0, (bp->elem_size * RESMGR_Q_SIZE));
				break;
			...
			case DEVI_CLASS_ABS:
				...
				memset (bp->u.tq, 0, (bp->elem_size * RESMGR_Q_SIZE));
				break;
			...
			case DEVI_CLASS_CONTROL:
				...
				memset (bp->u.cq, 0, (bp->elem_size * RESMGR_Q_SIZE));
				break;
			...
			case DEVI_CLASS_JOYSTICK:
				...
				memset (bp->u.jq, 0, (bp->elem_size * RESMGR_Q_SIZE));
				break;
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devi/lib/eventbus.c $ $Rev: 697744 $")
#endif
