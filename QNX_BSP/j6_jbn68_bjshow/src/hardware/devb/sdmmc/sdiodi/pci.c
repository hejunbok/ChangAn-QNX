...
int sdio_pci_device( sdio_hc_t *hc )
{
	...
	aflgs	= ( prod->aflags ? prod->aflags : PCI_INIT_ALL );
	aflgs	|= ( cfg->bus ? PCI_SEARCH_BUSDEV : PCI_SEARCH_VENDEV );
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devb/sdmmc/sdiodi/pci.c $ $Rev: 680332 $")
#endif
