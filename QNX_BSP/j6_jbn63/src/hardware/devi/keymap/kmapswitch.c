...
#define DEFAULT_KEYBOARD_PATH	"/etc/system/config/keyboard/"
...
int load_kbd( p_kmap_data dp, const char *name ) 
{
	...
	{
	char *def_path;
	if ((def_path = getenv("KEYDEF_PATH"))) 
	    {
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devi/keymap/kmapswitch.c $ $Rev: 697744 $")
#endif
