...
typedef struct _omap_ext {
	...
	int		wp_polarity;		/* WP I/O pin polarity (0 == LOW, 1 == HIGH) */
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devb/sdmmc/arm/omap_generic.le.v7/bs.h $ $Rev: 757124 $")
#endif
