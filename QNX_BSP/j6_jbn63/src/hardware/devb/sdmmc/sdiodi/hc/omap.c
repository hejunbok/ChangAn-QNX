...
static int omap_pwr( sdio_hc_t *hc, int vdd )
{
	...
	if( !vdd ) {
		out32( base + MMCHS_SYSCONFIG, in32( base + MMCHS_SYSCONFIG ) | SYSCONFIG_SOFTRESET );
		omap_waitmask( hc, MMCHS_SYSSTATUS, SYSSTATUS_RESETDONE, SYSSTATUS_RESETDONE, 10000 );
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devb/sdmmc/sdiodi/hc/omap.c $ $Rev: 759045 $")
#endif
