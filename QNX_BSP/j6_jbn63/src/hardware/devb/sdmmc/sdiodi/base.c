...
{
	return( xpt_alloc( XPT_ALLOC_CONTIG | XPT_ALLOC_NOCACHE, size, NULL ) );
}
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devb/sdmmc/sdiodi/base.c $ $Rev: 752217 $")
#endif
