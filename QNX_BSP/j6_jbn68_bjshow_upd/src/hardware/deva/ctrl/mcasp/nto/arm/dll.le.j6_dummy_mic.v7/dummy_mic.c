...
/* MCLK=12.288MHz, Fs=48KHz, and assuming R=1, then:
 P = 1 [10MHz <= (MCLK/P) <= 20MHz]
 K = (48000 * 2048 * 1)/(12288000) = 8
 J = 8 [4 <= J <= 55]
 D = 0
*/
#define NUM_CLOCK_ENTRIES 4
static uint32_t codec_pll_dividers[NUM_CLOCK_ENTRIES][6] = {
                             /* MCLK      Q  P  R  J  D */
	/* mclk = 12.288 MHz */   {12288000, 0, 1, 1, 8, 0},
