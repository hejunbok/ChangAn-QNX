...
int32_t f3s_qspi_sync(f3s_dbase_t *dbase, f3s_access_t *access, uint32_t flags, uint32_t offset)
{
	...
	rc = qspi_flash_chip_busy(access->socket.socket_handle);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/flash/boards/ti_qspi/f3s_qspi_sync.c $ $Rev: 744783 $")
#endif
