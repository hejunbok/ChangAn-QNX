                    ...
                    uint8_t *buffer)
{
    ...
    size = min(size, qspi->chip_size - offset);

    qspi_flash_read(qspi, offset, buffer, size);
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/flash/boards/j6evm-qspi/f3s_qspi_read.c $ $Rev: 738509 $")
#endif
