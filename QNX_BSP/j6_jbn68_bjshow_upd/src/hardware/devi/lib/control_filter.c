...
/*
		if (verbosity >= 3)
			printf ("Raw control filter data Rx: %d Ry: %d Rz: %d Buttons: %x\n", p->Rx, p->Ry, p->Rz, p->button_state);
*/
		mbuf.Rx = p->Rx;
		mbuf.Ry = p->Ry;
		mbuf.Rz = p->Rz;
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devi/lib/control_filter.c $ $Rev: 697744 $")
#endif
