...
#define TI814X_CPSW_BASE				0x48484000
#define TI814X_CPSW_SIZE				0x4000

#define TI814X_CPSW_MDIO_OFFSET			0x00001000

/* TI814x Interrupt Vectors */
#define TI814x_RX_INT0			147	  /* RX Pulse interrupt */
#define TI814x_TX_INT0			148	  /* TX Pulse interrupt */
#define TI814x_MISC_INT0		149	  /* Misc interrupt */
...
#define P1_CONTROL				0x00000200
	...
	#define TS_130					(1<<10)
	#define TS_129					(1<<9)
	#define TS_TTL_NONZERO				(1<<8)
	#define TS_UNI					(1<<7)
	#define TS_ANNEX_F				(1<<6)
	#define TS_ANNEX_E				(1<<5)
	#define TS_ANNEX_D				(1<<4)
...
#define CPPI_DESC_PHYS				0x48486000	  /* Physical address of descriptors in CPPI RAM */
...
#define CMR_BASE				0x4a002000	  /* Control Module Registers */
#define CMR_MODULE_SIZE				0x00008000
/* Register Definitions */
#define MAC_ID0_LO				0x00000514
#define MAC_ID0_HI				0x00000518
#define MAC_ID1_LO				0x0000051c
#define MAC_ID1_HI				0x00000520
#define DSS_PLL_CONTROL				0x00000538
	#define HDMI_DSS_DISABLE			(1 << 2)
#define GMII_SET				0x00000554
	#define	GMII0_SEL_RMII				0x00000001
	#define	GMII0_SEL_RGMII				0x00000002
	#define	GMII1_SEL_RMII				0x00000010
	#define	GMII1_SEL_RGMII				0x00000020
#define CONTROL_IO_2				0x00000558
	#define DESHDCP_CLK				(1 << 0)
#define GMAC_CLKCTRL				0x000073d0
#define GMAC_CLKCTRL_RFT_MASK				0x0e000000
#define GMAC_CLKCTRL_RFT_VID1				0x00000000
#define GMAC_CLKCTRL_RFT_VID2				0x02000000
#define GMAC_CLKCTRL_RFT_ABE				0x04000000
#define GMAC_CLKCTRL_RFT_HDMI				0x06000000
#define GMAC_CLKCTRL_RFT_AON				0x08000000

#define	RMII		1
#define	GMII		2
#define	RGMII		3
	
#define DSS_BASE				0x58040000
#define DSS_SIZE				256
#define HDMI_WP_PWR_CTRL			0x00000040
	#define PLL_PWR_ON				(0x2 << 2)
	#define PLL_STATUS_MASK				0x00000003
	#define PLL_STATUS_ON				0x2

#define PLLSS_BASE					0x4a0a6000
#define PLLSS_SIZE					0x400
#define HDMIPLL_CONTROL					0x0
	#define HSDIV_SYSRESETN					(1<<4)
	#define PLL_SYSRESETN					(1<<3)
#define HDMIPLL_STATUS					0x4
	#define SSC_EN_ACK					(1<<12)
	#define BYPASSACKZ_MERGED				(1<<9)
	#define PLL_BYPASS					(1<<6)
	#define PLL_HIGHJITTER					(1<<5)
	#define PLL_LOSSREF					(1<<3)
	#define PLL_RECAL					(1<<2)
	#define PLL_LOCK					(1<<1)
	#define PLLCTRL_RESET_DONE				(1<<0)
#define HDMIPLL_GO					0x8
	#define PLL_GO						(1<<0)
#define HDMIPLL_CONF1					0xc
	#define PLL_REGM_SHIFT					9
	#define PLL_REGN_SHIFT					1
#define HDMIPLL_CONF2					0x10
	#define REFSEL_SHIFT					21
		#define REFSEL_PCLK					0
		#define REFSEL_REF1					1
		#define REFSEL_REF2					2
		#define REFSEL_SYSCLK					3
	#define HSDIVBYPASS					(1<<20)
	#define BYPASSEN					(1<<15)
	#define PHY_CLKINEN					(1<<14)
	#define PLL_REFEN					(1<<13)
	#define PLL_HIGHFREQ					(1<<12)
	#define PLL_CLKSEL					(1<<11)
	#define PLL_LOCKSEL_SHIFT				9
		#define PLL_LOCKSEL_PHASE				0
		#define PLL_LOCKSEL_FREQ				1
	#define PLL_DRIFTGUARDEN				(1<<8)
	#define PLL_LOWCURRSTBY					(1<<6)
	#define PLL_PLLPMODE					(1<<5)
	#define PLL_SELFREQDCO_SHIFT				1
		#define PLL_SELFREQDCO_LOW				2
		#define PLL_SELFREQDCO_HI				4
	#define PLL_IDLE					(1<<0)
#define HDMIPLL_CONF3					0x14
	#define PLL_SD_SHIFT					10
#define HDMIPLL_SSC_CONF1				0x18
	#define DOWNSPREAD					(1<<2)
	#define EN_SSC						(1<<0)
#define HDMIPLL_SSC_CONF2				0x1c
	#define DELTAM2						(1<<30)
	#define MODFREQDIVIDER_SHIFT				20
#define HDMIPLL_CONF4					0x20
	#define PLL_REGM2_SHIFT					18

#define PLL_DELAY	10
#define PLL_MAX_LOOP	1000
...
typedef	struct {
	...
	struct _iopkt_inter		inter_event;
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/io-pkt/sys/dev_qnx/dm814x/arm/j6.dll.le.v7/ti814x.h $ $Rev: 758089 $")
#endif
