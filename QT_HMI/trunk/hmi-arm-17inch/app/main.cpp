...
//#ifdef QNX_WEATHER_WINDOW   //has relationship with font size of play music page
/**
...
int main(int argc, char **argv)
{
...
#else
    Core core(&windowManager, &applicationManager, &navigationController, 0, 0);
#endif
#else
    Core core(&windowManager, &applicationManager, 0, &weatherApplication, 0);
#endif
    Q_UNUSED(core);
    ...
    availPages[BtWifi_SettingsWorkflow::SoftwareUpdatesPage] = false; // alvays available
