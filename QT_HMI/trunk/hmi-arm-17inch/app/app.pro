...
DEFINES += QT_NO_CAST_FROM_ASCII QT_NO_CAST_TO_ASCII QT_NO_URL_CAST_FROM_STRING #QNX_ALL QNX_WEATHER_WINDOW QNX_CAMERA_COMTROLLER QNX_NAVIGATION_COMTROLLER
