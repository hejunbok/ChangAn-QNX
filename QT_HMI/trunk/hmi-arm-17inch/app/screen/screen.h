...
typedef struct _screen_mode {
        uint32_t width;             /**< Width of display */
        uint32_t height;            /**< Height of display*/
        uint32_t refresh;           /**< Refresh of display */
        uint32_t interlaced;        /**< Interlace mode of display */
        uint32_t aspect_ratio[2];   /**< Aspect ratio of display */
        uint32_t flags;             /**< Mutext flags of display */
        uint32_t index;             /**< Index of display */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/screen/public/screen/screen.h $ $Rev: 743844 $")
#endif
