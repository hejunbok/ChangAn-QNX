...
{
    m_ppsObject = new QPps::Object(QStringLiteral("/pps/qnxcar/hvac"),  false, QPps::Object::PublishAndSubscribeMode, true, this);
...
{
    const int fanTemperatureLeft = qBound(15, rawFanTemperatureLeft, 26);
...
{
    const int fanTemperatureRight = qBound(15, rawFanTemperatureRight, 26);
