...
Item {
    ...
    Row {
        ...
        PushButtonFromImage {
            ...
            checkable: true
            checked: _mediaPlayerModule.currentAudioState.repeatMode === RepeatMode.ALL
        ...
        PushButtonFromImage {
            ...
            checkable: true
            checked: _mediaPlayerModule.currentAudioState.repeatMode === RepeatMode.ONE
        ...
        PushButtonFromImage {
            ...
            checkable: true
            checked: _mediaPlayerModule.currentAudioState.shuffleMode === ShuffleMode.ON
