...
def Options():
    o = build_qt5.Options()
    o.baseConfigureFlags = '-v -no-cups -no-icu -no-xcb -no-eglfs -no-javascript-jit -no-gtkstyle -no-iconv -opensource -no-pch -confirm-license'
    o.qt5_modules = 'qtbase qtxmlpatterns qtdeclarative qtsvg qtgraphicaleffects'
    o.qt5_installbase = '/base/qt5-5.2'
    o.buildmode = 'release'
    o.qt5_version = '5.2.0-dev'
    o.opengl = True
    return o
...
if __name__ == "__main__":
    ...
    if not args.platform and sys.platform.startswith('Linux'):
