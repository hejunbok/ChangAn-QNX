...
Item {
    ...
    Image {
        ...
        anchors.topMargin: (parent.height - bkgrd_temperature_mode.height - bkgrd_SeatHeating.height - height) / 2 + bkgrd_temperature_mode.height + 20
        scale: 0.7
    ...
    DeformationButton{
        ...
        anchors.right: chair_image.left
        anchors.rightMargin: -155
        anchors.bottom: chair_image.bottom
