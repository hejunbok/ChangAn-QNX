...
{
    std::cout << "intersectionStatus = "<<intersectionStatus << std::endl;
    ...
    std::cout << "d->m_intersection = "<<d->m_intersection << std::endl;
...
{
    std::cout << "turnLeftStatus = "<<turnLeftStatus << std::endl;
    ...
    std::cout << "d->m_turn_left  = "<<d->m_turn_left  << std::endl;
...
{
    std::cout << "turnRightStatus = "<<turnRightStatus << std::endl;
    ...
    std::cout << "d->m_turn_right = "<<d->m_turn_right << std::endl;
