#ifndef QTQNXCAR2_ADDRESSBOOKSEARCHMODEL_H
#define QTQNXCAR2_ADDRESSBOOKSEARCHMODEL_H
...
/**
 * Model listing matched ASR contacts from the address book connected via Bluetooth.
 *
 * This model lists the matched ASR contacts available in the phonebook database (phonebook.db)
 *
...
class QTQNXCAR2_EXPORT AddressbookSearchModel : public SqlQueryModel
{
    Q_OBJECT
...
public:
     ...
     */
    explicit AddressbookSearchModel(QObject *parent = 0);
