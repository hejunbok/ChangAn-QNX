...
Item {
    ...
    states: [
        State {
            name: "LISTENING"
            when: _settingsModule.bluetoothListening
            ...
            PropertyChanges {
                ...
                onClicked: {
                    _settingsModule.stopBluetoothListening();
                }
            }
    ...
    Item {
        ...
        Item {
            ...
            visible: _settingsModule.bluetoothListening
            ...
            Label {
                ...
                //horizontalAlignment: Text.AlignHCenter
                //text: qsTr("%1 s").arg(_settingsModule.bluetoothRemainingListenTime)
                text: qsTr("%1 秒").arg(_settingsModule.bluetoothRemainingListenTime)
                fontSize: 48
            }
        }
        ...
        Item {
            ...
            ListView {
                ...
                model: _settingsModule.sortedRemoteDevices
        ...
        Row {
            ...
            SettingsButton {
                ...
                label.text: qsTr("监听")
                onClicked: {
                    _settingsModule.startBluetoothListening(60);
                }
            }
