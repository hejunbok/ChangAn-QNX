...
Item {
    ...
    FocusRemover {
        ...
        onPressed: {
            if(nameInput.text == "") {
                nameInput.text = _settingsModule.bluetoothDeviceName;
            }
        }
    }
    ...
    Item {
        ...
        LineEdit {
            ...
            onTextChanged: {
                if(nameInput.text != "") {
                    _settingsModule.bluetoothDeviceName = nameInput.text;
                    _settingsModule.saveBluetoothDeviceName();
                }
            }

            text: _settingsModule.bluetoothDeviceName;
        }
        ...
        ListView {
            ...
            model: _settingsModule.sortedPairedDevices
